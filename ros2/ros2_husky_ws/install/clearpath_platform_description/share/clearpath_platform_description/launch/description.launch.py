...
def generate_launch_description():
    ...
    # Paths
    husky_description_pkg = FindPackageShare('husky_description')
    clearpath_control_pkg = FindPackageShare('clearpath_control')

    robot_urdf = PathJoinSubstitution([
        husky_description_pkg, 'urdf', 'robot.urdf.xacro'])
    config_control = PathJoinSubstitution([
        clearpath_control_pkg, 'config', 'a200', 'control.yaml'])
