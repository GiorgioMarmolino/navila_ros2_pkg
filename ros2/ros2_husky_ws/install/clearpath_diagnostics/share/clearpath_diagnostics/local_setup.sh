...
: ${AMENT_CURRENT_PREFIX:="/home/ros_ws/install/clearpath_diagnostics"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/clearpath_diagnostics/environment/pythonpath.sh"
